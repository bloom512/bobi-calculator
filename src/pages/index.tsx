          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center gap-1 bg-white rounded-lg" style={{ width: '100%', maxWidth: '145px' }}>
                  <button
                    onClick={() => handleValueChange('A', Math.max(0, values.A - 1))}
                    className="w-8 h-8 flex items-center justify-center bg-gray-50 hover:bg-gray-100 active:bg-gray-200 active:scale-95 transition-all duration-100 text-base font-bold text-green-600 flex-shrink-0 rounded-full shadow-[0_1px_2px_rgba(0,0,0,0.06)]"
                  >
                    −
                  </button>
                  <input
                    ...
                    className="w-16 h-10 text-center text-lg font-bold text-gray-800 bg-white border border-gray-200 outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100 rounded-lg transition-all"
                  />
                  <button
                    onClick={() => handleValueChange('A', values.A + 1)}
                    className="w-8 h-8 flex items-center justify-center bg-gray-50 hover:bg-gray-100 active:bg-gray-200 active:scale-95 transition-all duration-150 text-base font-bold text-primary-600 flex-shrink-0 rounded-full shadow-[0_1px_2px_rgba(0,0,0,0.06)]"
                  >
                    +
                  </button>
                </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center gap-1 bg-white rounded-lg" style={{ width: '100%', maxWidth: '145px' }}>
                  <button
                    ...
                    className="w-9 h-9 flex items-center justify-center bg-gray-50 hover:bg-gray-100 active:bg-gray-200 active:scale-95 transition-all duration-150 text-lg font-bold text-green-600 flex-shrink-0 rounded-full shadow-[0_1px_2px_rgba(0,0,0,0.06)]"
                  >
                    −
                  </button>
                  <input
                  ...
                  <button
                    ...
                    className="w-9 h-9 flex items-center justify-center bg-gray-50 hover:bg-gray-100 active:bg-gray-200 active:scale-95 transition-all duration-100 text-lg font-bold text-primary-600 flex-shrink-0 rounded-full shadow-[0_1px_2px_rgba(0,0,0,0.06)]"
                  >
                    +
                  </button>
                </div>
